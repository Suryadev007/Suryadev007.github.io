    ...
    <div className="App">
      ...
      <div className="banner-section" id="banner-section">
        <div className="banner-content">
          <h1>
            experinced web{" "}
            <span className="developer-animation" data-text="developer">
              developer
            </span>
          </h1>
          <div className="banner-cta">
            <a href="mailto:suryadev7056@gmail.com">
              <button className="btn-primary">Hire Me</button>
            </a>
            <a href={cvDownload} target="_blank" rel="noreferrer">
        ...
        <div className="about-content row">
          ...
          <div className="about-text col-r">
            ...
            <p className="abt-info">
              Hi, I’m Surya Dev, a passionate Web Developer skilled in building
              modern, responsive, and user-friendly websites. I specialize in
              frontend development using technologies like React, HTML, CSS, and
              JavaScript, and I’m also experienced with CMS platforms such as
              WordPress and Shopify.
            </p>
            <p className="abt-info">
              I enjoy turning ideas into functional and visually appealing
              digital experiences that help businesses grow and users engage
              effortlessly.
            </p>
      ...
      <div className="about-section" id="experience">
        ...
        <div className="about-content row">
          <div className="about-image col-l">
            <img
              className="about-image-decor flip-stl"
              src={expImg}
              alt="About Me"
            />
          </div>
          ...
          <div className="about-text col-r">
            <h2>My Experience</h2>
            <ul className="exp-lst" id="exp-lst">
              {exp.map((item, index) => (
                <li key={index} className="li-abt-info">
                  <span className="time-line">{item.time}</span>
                  <span className="compony-name">
                    {item.title} <br></br>
                    {item.place}
                  </span>
                </li>
              ...
              {/* <li className="li-abt-info">
                ...
                <span className="compony-name">
                  Jr. Web Developer <br></br>TagHash Media, Mohali
                </span>
              </li>
              ...
              <li className="li-abt-info">
                ...
                <span className="compony-name">
                  Web Developer <br></br> SainSoft, LDH
                </span>
              </li>
              ...
              <li className="li-abt-info">
                ...
                <span className="compony-name">
                  Full Stack Developer Trainee <br></br> STEP-GNDEC, LDH
                </span>
              </li> */}
            </ul>
          </div>
          ...
          <div className="about-text col-r">
            ...
            <ul className="exp-lst">
              <li className="li-abt-info">
                ...
                <span className="compony-name">
                  Master's In Computer Application<br></br>GNDEC LDH,PB
                </span>
              </li>
              ...
              <li className="li-abt-info">
                ...
                <span className="compony-name">
                  Bachelor of Computer Applications<br></br>PCTE LDH,PB
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="about-text col-r full-width">
            ...
            <ul className="skills-lst">
              <li className="skill-list">
                <div className="cstm-icon" data-progress="100">
              ...
              <li className="skill-list">
                <div className="cstm-icon" data-progress="95">
              ...
              <li className="skill-list">
                <div className="cstm-icon" data-progress="80">
              ...
              <li className="skill-list">
                <div className="cstm-icon" data-progress="90">
      ...
      <div className="about-section" id="completed-projects">
        <div className="about-content row flex-col ">
          ...
          <div className="project-list full-width">
            ...
            <a
              className="project-item"
              href="https://cadillacuniform.com/"
              target="_blank"
              rel="noreferrer"
            >
              <div className="proj-img-cont">
            ...
            <a
              className="project-item"
              href="https://aaronscustomplumbing.com/"
              target="_blank"
              rel="noreferrer"
            >
              <div className="proj-img-cont">
      ...
      <div className="work-tog .about-content" id="contact">
        <div className="rows">
          <div className="col-l">
            <h2>
              Let's work together. <br></br>fixed a meeting
            </h2>
            <p>
